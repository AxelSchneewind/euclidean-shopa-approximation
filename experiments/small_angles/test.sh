...
for e in "${EPSILON[@]}"; do
	subdivision_stats graph results/$1_$2/instance_$1_$2.graph $e -h > results/$1_$2/stats_$e.csv
done
}
...
sed -e 's/graph,/graph,sin,/' -e 's/triangle_/triangle,/' -i results/results.csv
