...
python summarize.py -f results/aegaeis/results-unref.csv --output-queries=summaries/unref-queries.csv --column=ratio
python summarize.py -f results/aegaeis/results-unref.csv --output-queries=summaries/unref-queries.csv --column=time
