...
public:
    ...
    std::span<const internal_adjacency_list_edge<edge_info_type>, std::dynamic_extent>
    ...
    edge_id_type edge_index(const node_id_type &source, const node_id_type &destination) const {
