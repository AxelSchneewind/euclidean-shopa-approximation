...
using std_dijkstra = dijkstra<std_graph_t, default_queue_t, default_labels_t, default_neighbors<std_graph_t>, use_all_edges<std_graph_t>>;
using a_star_dijkstra = dijkstra<std_graph_t, a_star_queue_t, a_star_labels_t, default_neighbors<std_graph_t>, use_all_edges<std_graph_t>>;
...
using ch_dijkstra = dijkstra<ch_graph_t, default_ch_queue_t, default_ch_labels_t, default_neighbors<ch_graph_t>, use_upward_edges<ch_graph_t>>;
...
using steiner_dijkstra = dijkstra<steiner_graph, steiner_queue_t, steiner_labels_t, pruned_steiner_neighbors<steiner_graph, steiner_labels_t>, use_all_edges<steiner_graph>>;
