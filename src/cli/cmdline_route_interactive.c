/*
  ...
  gengetopt -i route_interactive.ggo -F cmdline_route_interactive 
...
#include "cmdline_route_interactive.h"
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->csv_format_help = gengetopt_args_info_help[9] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVg:o:e:c", long_options, &option_index);
