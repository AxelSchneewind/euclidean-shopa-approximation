/*
  ...
  /usr/bin/gengetopt -i src/cli/one-to-all.ggo -F cmdline_one_to_all --output-dir=src/cli --set-version=0.1 
...
#include "cmdline_one_to_all.h"

const char *gengetopt_args_info_purpose = "";

const char *gengetopt_args_info_usage = "Usage: compute_ota --graph-file /path/to/graph-file --output-directory\n/path/to/results-directory --epsilon 0.5 -q src0,src1,...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "computes the shortest path tree for each given source node.";
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --coords-explicit        if set, stores the coordinates of steiner points\n                                 explicitly  (default=off)",
  "\nquery:",
  "  -q, --query=STRING           list of source node ids",
  "\noutput:",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->coords_explicit_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->coords_explicit_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->coords_explicit_help = gengetopt_args_info_help[7] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->coords_explicit_given)
    write_into_file(outfile, "coords-explicit", 0, 0 );
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'e':	/* ε value to use for discretizing the triangulation (if a .graph file is given).  */
          ...
          break;
        case 'q':	/* list of source node ids.  */
        ...
        case 0:	/* Long option with no short option */
          /* if set, stores the coordinates of steiner points explicitly.  */
          if (strcmp (long_options[option_index].name, "coords-explicit") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->coords_explicit_flag), 0, &(args_info->coords_explicit_given),
                &(local_args_info.coords_explicit_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "coords-explicit", '-',
                additional_error))
              goto failure;
