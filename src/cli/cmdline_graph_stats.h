...
#ifndef CMDLINE_GRAPH_STATS_H
#define CMDLINE_GRAPH_STATS_H
...
#define CMDLINE_PARSER_PACKAGE "graph stats"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "graph stats"
#endif
...
struct gengetopt_args_info
{
  ...
  int header_flag;	/**< @brief print csv header (default=on).  */
  const char *header_help; /**< @brief print csv header help description.  */
  ...
  unsigned int mode_max; /**< @brief the type of information's maximum occurreces */
  const char *mode_help; /**< @brief the type of information help description.  */
