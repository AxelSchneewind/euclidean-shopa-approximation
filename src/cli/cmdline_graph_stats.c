/*
  ...
  /usr/bin/gengetopt -i /home/axel/Dokumente/Studium/Semester_7/routing/cmake-build-release/graph_stats.ggo -F cmdline_graph_stats --output-dir=src/cli 
...
#include "cmdline_graph_stats.h"

const char *gengetopt_args_info_purpose = "";

const char *gengetopt_args_info_usage = "Usage: graph_stats -g graph_file.graph -m mode ...";
...
const char *cmdline_parser_mode_values[] = {"steiner_graph_size", "bounding_box", "inangle_distribution", "node_radii", "points_per_edge", "steiner_points_by_angle", 0}; /*< Possible values for mode. */
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->mode_given, args_info->mode_min, args_info->mode_max, "'--mode' ('-m')"))
     error_occurred = 1;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * mode_list = NULL;
  int error_occurred = 0;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'g':	/* path to graph file (of type .fmi or .graph or .gl).  */
          ...
          break;
        case 'e':	/* epsilon for generation of steiner graph.  */
        ...
        case 'm':	/* the type of information.  */
          ...
          if (update_multiple_arg_temp(&mode_list, 
              &(local_args_info.mode_given), optarg, cmdline_parser_mode_values, "steiner_graph_size", ARG_ENUM,
              "mode", 'm',
              additional_error))
            goto failure;
  ...
  multiple_default_value.int_arg = mode_arg_steiner_graph_size;
  update_multiple_arg((void *)&(args_info->mode_arg),
    &(args_info->mode_orig), args_info->mode_given,
    local_args_info.mode_given, &multiple_default_value,
    ARG_ENUM, mode_list);

  args_info->mode_given += local_args_info.mode_given;
  local_args_info.mode_given = 0;
