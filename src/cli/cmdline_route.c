/*
  ...
  /usr/bin/gengetopt -i src/cli/route.ggo -F cmdline_route --output-dir src/cli 
...
const char *gengetopt_args_info_help[] = {
  ...
  "\ninput/output files:",
  "  -g, --graph-file=STRING       path to graph file (of type .fmi or .graph)",
  "  -o, --output-directory=STRING path to output directory (where the\n                                  subdirectory with the output files should be\n                                  created)  (default=`.')",
  "\ntriangulation:",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->project_help = gengetopt_args_info_help[13] ;
