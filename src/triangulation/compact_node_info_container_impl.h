...
template<typename AggregateId, typename IntraAggregateId, typename AggregateInfo, typename Info>
std::span<const Info>
compact_node_info_container<AggregateId, IntraAggregateId, AggregateInfo, Info>::node_infos(edge_id_type edge_id) const {
    return get(edge_id);
}
...
template<typename AggregateId, typename IntraAggregateId, typename AggregateInfo, typename Info>
AggregateInfo
compact_node_info_container<AggregateId, IntraAggregateId, AggregateInfo, Info>::get_aggregate_info(AggregateId agg_id) {
...
constexpr compact_node_info_container<AggregateId, IntraAggregateId, AggregateInfo, Info>::aggregate::aggregate(
        AggregateId aggregate_id, AggregateInfo aggregate_info, std::vector<Info> info) : aggregate_id(aggregate_id), aggregate_info(aggregate_info), info(info) {}
...
compact_node_info_container<AggregateId, IntraAggregateId, AggregateInfo, Info>::aggregate::aggregate(
        compact_node_info_container::aggregate &&other) : aggregate_id(other.aggregate_id), aggregate_info(other.aggregate_info), info(std::move(other.info)) {}
